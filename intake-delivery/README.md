...
**Live ID:** `xaimeFYbzIHzvTpB` · **Triggers:** Tally webhook POST `/PPW`, or Google Sheets polling · **Active:** no

Calls [`PPW · Thesis Chapters 1–3`](../thesis-chapters/README.md) (`khxRFfcjLCUpA29h`).
...
The live form is **[tally.so/r/ODepxp](https://tally.so/r/ODepxp)** ("Project Submission Form").
...
| `build-workflow.js` | regenerates `workflow.json`; reads the sub-workflow ID from `../thesis-chapters/.workflow-id` |
...
`Generate DOCX` inlines [`../thesis-chapters/docx-generator.js`](../thesis-chapters/docx-generator.js).
...
| Sub-workflow call target | verified: `khxRFfcjLCUpA29h` exists and validates |
...
[the sub-workflow README](../thesis-chapters/README.md#verification-status). What remains
